...
<body>
    <div class="div1">
        ...
        <div class="div2">
            <h1 style="font-size:30px;color: orange;font-style:arabic;">Change Password</h1>
...
if(isset($_POST['save'])){
    ...
    $sql="select * from del_boy where username='$user' and password='$op'";
    ...
    if($r=mysqli_fetch_assoc($q)){
        ...
        if($op==$db_pass){
            ...
            if(!isset($error)){
                ...
                $result = mysqli_query($con,"update del_boy set password='$np' where username='$user'");
                if($result){
